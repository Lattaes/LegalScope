...
const Footer = () => {
  return (
    <div className="bg-black text-gray-300 py-8 md:py-16">
      <section className="container mx-auto">
        <div className="grid md:grid-cols-3 py-5">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 col-span-2 md:pl-10">
            <div>
              <div className="py-8 px-4">
                <h1 className="sm:text-xl text-xl font-bold mb-3">Company</h1>
            ...
            <div>
              <div className="py-8 px-4">
                <h1 className="sm:text-xl text-xl font-bold mb-3">Help</h1>
                <ul className="flex flex-col gap-3">
                  {HelpLinks.map((link) => (
                    <li
                      key={link.title}
            ...
            <div>
              <div className="py-8 px-4">
                <h1 className="sm:text-xl text-xl font-bold mb-3">Resources</h1>
                <ul className="flex flex-col gap-3">
