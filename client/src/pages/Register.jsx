...
function Register() {
    ...
    const [data, setData] = useState({
      ...
      const registerUser = async (e) => {
        ...
        try {
            const response = await axios.post('http://127.0.0.1:3000/api/register', { username, email, password }, { withCredentials: true });
    ...
    return (
        <section className="bg-customNavy min-h-screen flex items-center justify-center">
            {/* register container */}
                ...
                <div className="md:w-1/2 px-8 md:px-16">
                    ...
                    <form onSubmit={registerUser} className="flex flex-col gap-4 mt-8">
                        ...
                        <div className="relative">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="gray" className="bi bi-eye absolute top-1/2 right-3 -translate-y-1/2" viewBox="0 0 16 16" onClick={togglePasswordVisibility}>
