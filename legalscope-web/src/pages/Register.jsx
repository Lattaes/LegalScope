      ...
      <div className="bg-gray-100 flex flex-col sm:flex-row rounded-2xl shadow-lg w-full max-w-screen-lg mx-auto px-4 sm:px-6 lg:px-8 py-5 items-center">
        ...
        <div className="md:w-1/2 px-8 md:px-16">
          ...
          <form action="" className="flex flex-col gap-4 mt-8">
            <input className="p-2 rounded-xl border" type="text" name="name" placeholder="Name" />
            ...
            <button className="bg-customMaroon rounded-xl text-white py-2 hover:scale-105 duration-300">Register</button>
          </form>
