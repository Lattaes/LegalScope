...
const Features = () => {
  return (
    <section
      className="features"
      style={{ background: "linear-gradient(to bottom, #541212, #000000)" }}
    >
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="feature-container bg-white p-6 shadow-lg rounded-lg relative">
            ...
            <h3 className="text-2xl font-bold mb-4 text-center">
              Daftar Hukum Indonesia
            </h3>
            <p className="text-center mb-6">
              Menggunakan teknologi NLP untuk memahami permintaan pengguna dan
              memberikan hasil pencarian yang relevan.
            </p>
          </div>
          <div className="feature-container bg-white p-6 shadow-lg rounded-lg relative">
            <img
            ...
            <p className="text-center mb-6">
              Algoritma AI mengelompokkan hasil berdasarkan jenis dan bidang
              hukum, serta menyediakan filter tambahan.
            </p>
          </div>
          <div className="feature-container bg-white p-6 shadow-lg rounded-lg relative">
            <img
            ...
            <p className="text-center mb-6">
              Memfasilitasi interaksi pengguna dengan database peraturan hukum,
              menyediakan ringkasan dan penjelasan singkat.
            </p>
          </div>
        </div>
        ...
        <div className="flex justify-center mt-8">
          <a
            href="/login"
            className="bg-customGreen text-white px-6 py-3 rounded-md hover:bg-emerald-900"
          >
            Get Started
          </a>
        </div>
